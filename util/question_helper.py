...
if __name__ == '__main__':
    ...
    questions = ["'s mother works in teaching, health care, civil services (e.g. administrative or police) or at_home",
                "'s mother works in an other field than teaching, health care, civil services (e.g. administrative or police) or at_home",
                 "whose mothers work in an other field than teaching, health care, civil services (e.g. administrative or police) or at_home",
                 ...
                 "'s mother had had more than Primary education until 4th grade",
                 "'s mother had had Primary education until 4h grade or less",
                 "whose mothers had had Primary education until 4h grade or less",
                 ...
                 "with a family size of less or equal to three",
                 ...
                 " studies an average time or more (more than 5 hours per week)",
                 ...
                 " has failed fewer or more classes than average (less than 2 or more than 2 classes)",
                 ...
                 "'s mother work at home",
                 "whose mothers work at home",

                 ]

    for i in range(0, len(questions), 3):
        print('If a secondary education *student{}*, what is the chance (or probability) that the student scored the same or better than the weaker half of the class? Give your best guess (between 0 and 1).'.format(questions[i]))
        print('If a secondary education *student{}*, what is the chance (or probability) that the student scored the same or better than the weaker half of the class? Give your best guess (between 0 and 1).'.format(questions[i+1]))
        print('What is the percentage of secondary education students *{}*? Give your best guess (between 0 and 1).'.format(questions[i+2]))
