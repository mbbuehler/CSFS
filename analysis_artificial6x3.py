...
def evaluate():
    ...
    Parallel(n_jobs=4)(delayed(visualise_results)(dn, dataset_class="artificial6x3", N_features=N_features, N_samples=N_samples, target=target) for dn in dataset_names)
    # N: #data points
    # M: #parameters
